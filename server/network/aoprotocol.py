...
class AOProtocol(asyncio.Protocol):
    ...
    def net_cmd_ms(self, args):
        ...
        msg = dezalgo(text, regex=self.server.zalgo_regex, tolerance=self.server.zalgo_tolerance)
    ...
    def net_cmd_ct(self, args):
        ...
        args[1] = dezalgo(args[1], regex=self.server.zalgo_regex, tolerance=self.server.zalgo_tolerance)
        if self.client.shaken:
